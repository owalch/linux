//*****************************************************************************
// ipCom.cc IP Socket Functions
// Author:  M. Thaler, ZHW
//          M. Pellaton
// Date:    11.2.2000
// History: 30. 12. 2001, M. Pellaton -> GetActualhostName()
//          29/03/2008 M. Thaler: single connection socket server
//          5/2008 M. Thaler: using getaddrinfo -> IPV4 and IPV6 compatible
//*****************************************************************************
...
int WaitForClient(int sfd, char *buffer) {
    ...
    cfd = accept(sfd,(struct sockaddr *)&addr,(unsigned *)&addrlen);
    if (cfd >= 0) {
